...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Drax" },
      { property: "og:title", content: "Drax — Disparos de WhatsApp em Escala" },
      { property: "og:description", content: "API Oficial e Alternativa para campanhas em massa no WhatsApp. Cadastro gratuito, sem mensalidade." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Drax — Disparos de WhatsApp em Escala" },
      { name: "twitter:description", content: "Plataforma WABA profissional para marketing, cobrança e vendas no WhatsApp." },
    ],
    links: [
      {
        rel: "stylesheet",
